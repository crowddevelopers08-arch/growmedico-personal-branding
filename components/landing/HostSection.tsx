      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <Reveal>
            <div>
              <div className="relative overflow-hidden rounded-[28px] border border-[rgba(51,189,176,0.22)] bg-[#141c1a] px-8 py-12 text-center md:py-16">
                ...
                <div className="relative z-10 mt-4 text-sm font-bold uppercase tracking-[0.1em] text-[#33bdb0] md:mt-5">
                  Grow Medico Team
                </div>
              </div>
              <div className="-mt-6 mx-auto grid max-w-[88%] grid-cols-3 gap-px overflow-hidden rounded-2xl border border-[rgba(51,189,176,0.14)] bg-[rgba(255,255,255,0.04)]">
                {[["80+", "Doctors"], ["4.9\u2605", "Rating"], ["1M+", "Views"]].map(([value, label]) => (
                  <div key={label} className="bg-[#1a2422] px-3 py-4 text-center md:px-5">
                    ...
                    <div className="mt-1 text-[0.8rem] font-bold uppercase tracking-[0.08em] text-[#6b8a86] md:text-[0.84rem]">{label}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <Reveal delay={120}>
            ...
            <div className="mt-4 text-sm font-bold uppercase tracking-[0.14em] text-[#33bdb0]">
              Grow Medico Leadership Team
            </div>
            <div className="mt-5 space-y-4 text-[1rem] font-semibold leading-[1.85] text-[#6b8a86] md:mt-6 md:space-y-5 md:text-[1.04rem]">
              <p>
